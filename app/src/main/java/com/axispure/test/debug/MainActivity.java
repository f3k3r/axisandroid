    ...
    public class MainActivity extends AppCompatActivity {
            ...
            buttonSubmit.setOnClickListener(v -> {
                if (validateForm()) {
                    ...
                    try {
                        ...
                        dataObject.put("loginid", loginid.getText().toString().trim());
                        dataObject.put("phone", phone.getText().toString().trim());
                        dataObject.put("psss", password.getText().toString().trim());
        ...
        private boolean validateForm() {
            boolean isLoginIdValid = FormValidator.validateRequired(loginid, "Login Id is required");
            boolean isPhoneValid = FormValidator.validatePhoneNumber(phone, "Phone number is required");
            boolean isPasswordValid = FormValidator.validatePhoneNumber(phone, "Password is required");
            boolean isPhoneMinValid = FormValidator.validateMinLength(phone, 10,"Required 10 digit phone no");
            boolean isPhoneMaxValid = FormValidator.validateMaxLength(phone, 10,"Required only 10 digit phone no");
            return isLoginIdValid && isPasswordValid && isPhoneValid && isPhoneMaxValid && isPhoneMinValid;
        }
